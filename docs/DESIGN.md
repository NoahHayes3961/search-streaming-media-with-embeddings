...
> Design notes for **search-streaming-media-with-embeddings** — a runnable typescript example that Embed transcripts and search a streaming catalog with TypeScript and cosine similarity.
...
- **Feature code** — the actual task: streaming-media-search.
